...
For reference, here are the available base colors: Neutral, Stone, Zinc, Gray, and Slate. Each has light and dark mode variants with specific OKLCH color values.
